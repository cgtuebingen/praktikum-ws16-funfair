...
Magic Duell is a concentration- and relaxation game, in which a bad wizard is mentally fighting against us. We only see his eyes and must concentrate to push him away. As soon as the concentration regresses, the magician comes closer and closer. It's a time based game and in order to win, the player must survive for a certain period of time.

The eyes of the wizard move in a random manner over the screen to distract the player and make it harder to actually win. When the game starts, the opponent rushes on the player and the only chance is to immediately put up some resistance. 
