...
\begin{figure}
	% produced by human_experiments/data_analysis/analysis.R
	\centering
	\subfloat{\includegraphics[width=0.2\columnwidth]{images/lena_6.jpg}}\hspace{0.05\columnwidth}
	\subfloat{\includegraphics[width=0.2\columnwidth]{images/lena_24.jpg}}\hspace{0.05\columnwidth}
	\subfloat{\includegraphics[width=0.2\columnwidth]{images/lena_26.jpg}}\hspace{0.05\columnwidth}
	\subfloat{\includegraphics[width=0.2\columnwidth]{images/lena_21.jpg}}
