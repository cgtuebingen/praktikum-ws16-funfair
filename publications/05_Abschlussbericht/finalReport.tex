...
As most actions and spikes in the data lasted for a very brief period of time, roughly 1-2 seconds, we convolved all sensor data individually with a sliding window of 2 seconds, which corresponds to 256 data points per sensor since the sampling frequency was approximately 128 Hz.
...
\begin{figure*}[h!]
	\centering
	\includegraphics[width=1.0\textwidth]{images/sensor_values.pdf}
